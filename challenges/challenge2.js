 ...
 *    
 *    Expect to log 'Hello there, Ducky', then 'MAKE SCHOOL IS AWESOME!!!'.
 * 
 ...
 *    
 *    It does not run, and instead 'Received an error!' and 'Name must be a string!' 
 *    are logged.
 * 
 ...
 *    run the code again.
 *    
 *    This time greet() succesfully executes and then the error is thrown for uppercaser()
 *    failing. 
 * 
...
const name = 'Ducky'
const my_str = 'This is my long test string!'
